...
team_tva_ranking <- future_map(
  ...
  ~ {
    ...
    draft_picks2_year2 <- prep_draft_picks(
      standings_year1,
      year = this_year + 1,
      "second year"
    )
    ...
    list(
      year1 = standings_year1,
      year2 = standings_year2,
      year3 = standings_year3
    )
  },
  .progress = TRUE,
...
# warning: 8 min
final_standings_odds <- compute_final_standings_odds(
  current_table,
  team_tva_list,
  points_fit_coef,
  years = 3,
