...
write_csv(
  ...
  here("Shiny/Saved Files/overall_transaction_winners.csv")
)
...
write_csv(
  ...
  here("Shiny/Saved Files/transaction_comparison.csv")
)
...
save(
  total_transaction_value,
  file = here("Shiny/Saved Files/total_transaction_value.Rdata")
)
