  ...
  dashboardBody(
    tabItems(
      tabItem(
        ...
        p(
          "Hello! This website hosts results and analysis for the Baylor Seniors Fantasy Football Superflex Dynasty League. The foundation of the analysis
        rests on the novel",
          strong("value added"),
          "metric. I model player's future success and organize data in an (hopefully)
        ...
        the league. It should supplement- and not replace- the league information you find on Sleeper and the popular fantasy player valuing
          ...
          "In fact, several of my models leverage
        ...
        p(
          "I separate the information on this website into three categories: retrospective analysis, projections, and league archives. Retrospective
        ...
        p(
          "A fantasy players'",
          strong("value added"),
          "measures a fantasy player's actual value contributed to a user. I measure a players' value
        ...
        p(
          "The replacement level value is the same for all players of the same position and is defined as the top bench player
        ...
        p(
          "A players' value added can change drastically depending on the player's position and the team's composition. For example, a user starts
        ...
        h4("Future Value"),
        p(
          "Put simply, a player's ",
          strong("future value"),
          " is his expected value added in future seasons. It's difficult to project this
        ...
        h4("Other Models"),
        p(
          "The simulations of players' future value open the door for other models and insights. I use the players' realized value and future
        ...
        h4("A Disclaimer"),
        p(
          "As with any model, these projections have their fair share of deficiencies. First, the model is trained on only a single year of data. This means
      ...
      tabItem(
        ...
        fluidRow(
          column(
            ...
            p(
              "Select any player and this page will report the players' value added and future value. The future value for each year is the
      ...
      tabItem(
        ...
        fluidRow(
          column(
            ...
            p(
              "Select a user to view the fantasy teams' top assets and acquisitions."
            ),
      ...
      tabItem(
        ...
        p(
          "Select a draft to view the top picks and best overall drafts. The users' expected value is the
      ...
      tabItem(
        ...
        p(
          "The most successful transactions in league history. This is assessed now, not the time of the transaction."
        ),
      ...
      tabItem(
        ...
        p(
          "The most unfair trades in league history. This is assessed now, not the time of the trade."
        ),
      ...
      tabItem(
        ...
        It outputs the net future value and net next year value for each fantasy team. ",
          strong("NOTE:"),
          " net next year value is the estimated
      ...
      tabItem(
        ...
        p(
          "Demonstrates a players' future value at different points in the league history. Please note that
      ...
      tabItem(
        ...
        p(
          "Let \\(x_{j w}\\) denote the fantasy points that player \\(j\\) in week \\(w = 1, \\ldots, 17\\)
        ...
        p(
          "Finally, a players future value is defined as a discounted sum of the median predicted seasonal value over the next eight seasons:",
        ...
        p(
          "I plot drafted player's Total Value Added across their rookie draft position. The blue line is the median projected
...
server <- function(input, output, session) {
  ...
  output$avenue_grades <- renderDT({
    ...
    users %>%
      ...
      select(roster_id) %>%
      pull() %>%
      overall_grades(value_avenues, ., shiny = TRUE) %>%
      datatable(
        options = list(
          pageLength = 5, # Set the initial number of rows per page
          ordering = TRUE, # Enable column sorting
  ...
  output$team_composition <- renderDT({
    ...
    users %>%
      ...
      select(roster_id) %>%
      pull() %>%
      team_composition(player_avenues, ., shiny = TRUE) %>%
      datatable(
        options = list(
          pageLength = 5, # Set the initial number of rows per page
          ordering = TRUE, # Enable column sorting
  ...
  output$individual_transaction_title <- renderUI({
    ...
    h3(
      total_transaction_value[[input$transaction_selection]]$team_name[1] %>%
        str_c(
          .,
          "'s ",
          total_transaction_value[[input$transaction_selection]]$season[1],
          " W",
          total_transaction_value[[input$transaction_selection]]$week[1],
          " Transaction"
        )
    )
  })
  ...
  output$individual_trade_title <- renderUI({
    ...
    h3(
      total_trade_value[[input$trade_selection]] %>%
        select(team_name) %>%
        distinct() %>%
        map_chr(~ str_c(.x, collapse = ", ")) %>%
        str_c(
          total_trade_value[[input$trade_selection]]$season[1],
          " W",
          total_trade_value[[input$trade_selection]]$week[1],
          " Trade between ",
          .
        )
    )
